        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListToWatchId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movies_ToWatch_ListToWatchId",
                        column: x => x.ListToWatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_ListToWatchId",
                table: "Movies",
                column: "ListToWatchId");
